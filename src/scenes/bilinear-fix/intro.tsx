    ...
    yield view.add(
        <>
            <Layout direction={'column'} padding={32} width={'100%'} height={'100%'} alignItems={'center'} justifyContent={'center'} layout>
                <Txt text={"Bilinear Fix"} fill={'#e4e4e4'} stroke={'#141414'} lineJoin={'round'} lineWidth={32} strokeFirst={true} fontFamily={'JetBrains Mono'} fontSize={60} fontWeight={800} />
                <Txt text={"A fundamental disconnect!"} marginTop={32} fill={'#848484'} stroke={'#141414'} lineJoin={'round'} lineWidth={32} strokeFirst={true} fontFamily={'JetBrains Mono'} fontSize={30} fontWeight={800} />
            </Layout>
        </>
    );
